...
### 1. 담배꽁초 수거 로봇
- **작품 개요**
  - 한류 열풍으로 외국인 관광객 증가 -> 도심 미관 중요성 확대
  - 홍대 등 주요 도심지의 담배꽁초, 쓰레기 문제 심각
  - 강남 홍수 사태에서 빗물받이 막힘의 원인이 담배꽁초 및 쓰레기
 
- **주요 기능**
   - 술집 골목, 좁은 공간에서도 주행가능
   - 담배꽁초를 자동으로 탐지하고 수거하는 기능
   - 소형 청소 로봇
 
- **기대 효과**
  - 도시 미관 개선 및 관광객 만족도 향상
  - 침수, 홍수 피해 예방(배수로 막힘 방지)
  - 기존 대형 청소 장비의 한계 보완
